# Data Engineering & AI/ML Portfolio

A collection of projects showcasing skills in machine learning, statistical analysis, data engineering, and Python software design.

## Structure

| Folder | Projects | Focus |
|---|---|---|
